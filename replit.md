...
```
Changelog:
- July 31, 2025. CRITICAL SHOPIFY PAGE TITLE/META TITLE SEPARATION COMPLETED: Fixed major issue where meta titles were incorrectly used as both page titles and SEO titles in Shopify pages - separated article title (visible page heading) from meta title (SEO only) by using article title for pageData.page.title and moving meta title to global.title_tag metafields with global namespace - corrected initial seo namespace to proper global namespace per Shopify standards - pages now display correct headings while maintaining proper SEO optimization with separate meta titles for search engines
