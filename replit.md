...
- **Author Avatar Image Sizing Fix**: Fixed oversized author avatar images in blog posts by reducing bottom author box avatar size to 24×24px for optimal proportion that matches typical blog post author sections. Also fixed LinkedIn integration to properly use avatarUrl field instead of profileImage, and ensured LinkedIn buttons appear in the bottom author section when available.
