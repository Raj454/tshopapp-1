...
- **Author Avatar Image Sizing Fix**: Fixed oversized author avatar images in blog posts by reducing bottom author box avatar size from 40px to 32px for better proportion. Also fixed LinkedIn integration to properly use avatarUrl field instead of profileImage, and ensured LinkedIn buttons appear in the bottom author section when available.
