// Manual Shopify API test content creation
const axios = require('axios');

async function createTestContent() {
  const store = 'rajeshshah.myshopify.com';
  ...
  const blogPostData = {
    article: {
      ...
      body_html: `<div style="background-color: #f9f9f9; border-left: 4px solid #007bff; padding: 16px; margin: 24px 0; clear: both;">
...
<p><strong>Welcome to our Table of Contents navigation test!</strong><br>This demo article will help you understand the difference between TOC navigation links (which stay on the same page) and external reference links (which open in new tabs).</p>
...
<p><em>Test page created to verify TOC navigation in Shopify pages.</em></p>`,
  ...
  console.log('Use Shopify Admin API to create these test items');
}
