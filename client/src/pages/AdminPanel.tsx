...
export default function AdminPanel() {
  ...
  // Editable content state for preview
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {editableTitle.length}/60 characters (recommended for SEO)
                      </p>
                    </div>

                    {/* Editable Meta Description */}
                    <div>
                      <Label htmlFor="edit-description" className="text-sm font-medium">Meta Description</Label>
                      <Textarea
                        id="edit-description"
                      ...
                      />
                      <p className="text-xs text-muted-foreground mt-1">
                        {editableDescription.length}/160 characters (recommended for SEO)
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-muted-foreground mt-1">
                        You can edit the content directly here before publishing
                      </p>
                    </div>
                  </div>
                ) : (
