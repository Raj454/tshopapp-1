  ...
  const generateCluster = async () => {
    ...
    try {
      ...
      const mockCluster = clusterTopics.map((title, index) => ({
        ...
        <p>This article explores ${title} in detail, providing valuable insights for readers at all levels.</p>
        
        <h2>Key Points About ${title}</h2>
        <p>When considering ${title}, keep these important factors in mind:</p>
        <ul>
          <li>Understanding the fundamentals is crucial</li>
          <li>Practice makes perfect - try these techniques regularly</li>
          <li>Stay updated with the latest trends</li>
        </ul>
        
        <h2>Implementation Strategies</h2>
        <p>To successfully implement ${title}, follow these proven steps:</p>
        <ol>
        ...
        <h2>Conclusion</h2>
        <p>By following the guidance in this article, you'll be well on your way to mastering ${title}.</p>`,
