// Create test TOC content for Shopify testing
...
<ol>
  ...
  <li>Check your browser's address bar - it shows the section anchor</li>
</ol>
...
`,
  ...
  metaDescription: "Test article demonstrating Table of Contents navigation functionality with same-page anchor links in Shopify."
};
...
`,
  metaDescription: "Test page demonstrating Table of Contents navigation functionality in Shopify pages."
};

console.log("Test content prepared for both blog post and page");
console.log("Blog post title:", testBlogContent.title);
console.log("Page title:", testPageContent.title);